...
form.addEventListener('submit', e=> { 
    ...
    tempText=tempText.map(item => item+"<br> <br>").join('');
    document.getElementById("result").innerHTML=tempText;
})

numofpara.addEventListener('input', synParaNumber);
numofparaRange.addEventListener('input',synParaNumber);